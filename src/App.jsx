...
const FEATURED_PROJECTS = [
  ...
  },
  {
    ...
    subtitle: "Graduation Project Winner — Bahir Dar University 2026",
    role: "Full-Stack Web Application",
    description: "Award-winning graduation project combining rapid restaurant ordering with interactive social discovery, enabling users to explore trending venues and share food experiences in real time.",
    stack: ["React", "Node.js"],
    link: "https://github.com/surafelbit",
    accent: "#ff6b2b",
    image: null
        ...
        <div className="timeline-container">
          ...
          {[
            ...
            },
            {
              ...
              description: 'Designed a backend system that allows multiple bills to be hosted and paid by integrating with Chapa API, maintaining security and traffic management. Focused on scalable backend architecture and secure payment processing.',
              tags: ['Backend Architecture', 'Chapa API', 'Payment Integration', 'Security'],
              highlight: false,
            },
            {
              type: 'work',
              ...
              company: 'Efuye Gela',
              location: 'Addis Ababa, Ethiopia',
              description: 'Built scalable backend architectures and robust API endpoints for internal platforms using Next.js. Focused on performance, maintainability, and seamless integration with frontend systems.',
              tags: ['Next.js', 'Backend Architecture', 'API Development'],
              highlight: false,
            },
            {
              type: 'award',
              period: '2026',
              role: 'Graduation Project Winner',
              company: 'Bahir Dar University',
              location: 'Bahir Dar, Ethiopia',
              description: 'Won the graduation project award at Bahir Dar University for building a high-performance social discovery and food delivery platform built with React and Node.js.',
              tags: ['React', 'Node.js'],
              highlight: false,
            },
            {
